      ...
      {shows.length !== 0 && (
        <div className="space-y-1 sm:space-y-2.5">
          ...
          <div className="relative w-full items-center justify-center overflow-hidden">
            ...
            <div
              ref={showsRef}
              className="no-scrollbar m-0 grid auto-cols-[calc(100%/3)] grid-flow-col overflow-x-auto overflow-y-hidden px-[2%] py-0 duration-500 ease-in-out sm:auto-cols-[25%] md:touch-pan-y lg:auto-cols-[20%] xl:auto-cols-[calc(100%/6)] 2xl:px-[60px]"
            >
              {shows.map((show) => (
